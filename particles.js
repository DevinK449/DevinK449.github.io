/* ============================================================
   ...
   Converted from ReactBits (reactbits.dev) Particles component
   Requires OGL loaded via CDN before this script
   ============================================================ */
  ...
  function init() {
    ...
    const program = new ogl.Program(gl, {
      ...
      uniforms: {
        ...
        uBaseSize: { value: CONFIG.particleBaseSize * dpr },
